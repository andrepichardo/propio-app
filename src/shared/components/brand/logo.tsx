 ...
 * sit at ~7:1, so it reads either way). The wordmark switches:
 *   - light: `fill-primary` = exactly `#48509e`, the designer's artwork.
 *   - dark:  near-white, tying it to the tile's own white glyphs. The brand
 *     indigo is unusable here (2.6:1), and a merely lightened indigo reads
 *     dull and washed out against the sidebar — white is the standard
 *     dark-mode wordmark treatment, and the tile still carries the colour.
 *
...
export function Logo({ className, showWordmark = true }: LogoProps) {
  return (
    ...
    >
      ...
      />
      {showWordmark ? (
        <g className="fill-primary dark:fill-foreground">
